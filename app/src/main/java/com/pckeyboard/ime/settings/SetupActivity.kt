 ...
 * and then routes the user into settings or the theme editor.
 */
class SetupActivity : AppCompatActivity() {
    ...
    private fun refreshStatus() {
        ...
        binding.statusEnabled.text =
            if (enabled) getString(com.pckeyboard.ime.R.string.setup_status_enabled_yes)
            else getString(com.pckeyboard.ime.R.string.setup_status_enabled_no)
